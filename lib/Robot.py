...
#            BlinkerThread(self, True)
    ...
    @staticmethod
    def getIPAddress(interface_name):
        '''
        interface_name is "eth0" for Ethernet and "wlan0" for WLan
        @return:  All IP addresses of given interface
        '''
        ...
        try:
            ip = socket.inet_ntoa(fcntl.ioctl(
                s.fileno(),
                0x8915,  # SIOCGIFADDR
                struct.pack('256s', interface_name[:15]))[20:24])
        except:
            pass
        return ip